...
set(CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH} "/h/opt/freeglut-3.0.0/")
set(CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH} "C:/Program Files/Common Files/MSVC/freeglut")
# message("Cmake prefix path: ${CMAKE_PREFIX_PATH}")

FIND_PATH(FREEGLUT_INCLUDE_DIR NAMES GL/glut.h)
#  HINTS PATH_SUFFIXES /h/opt/freeglut3.0.0)
